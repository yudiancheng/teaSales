...
<head>
    ...
    <script src="js/changeUserInfo.js" type="text/javascript"></script>
                ...
                <div class="about_user_info">
                    <form id="form1">
                        <div class="user_layout">
                            <ul >
                                <li><label class="user_title_name">用户头像：</label><a href="page/imageUpload.jsp">点击上传头像</a></li>
                                <li><label class="user_title_name">用户昵称：</label><input name="username" type="text"  class="add_text" value="${user.username}"/><i id="usernameMess">*</i></li>
                                <li><label class="user_title_name">真实姓名：</label><input name="realName" type="text"  class="add_text" value="${user.realName}"/><i id="realNameMess">*</i></li>
                                <li><label class="user_title_name">用户性别：</label>
                                    <label class="sex"> <input type="radio" name="sex" value="男" id="RadioGroup1_0" <c:if test="${user.sex eq '男'}">checked="checked"</c:if>/><span>男</span></label>
                                    <label class="sex"><input type="radio" name="sex" value="女" id="RadioGroup1_1"  <c:if test="${user.sex eq '女'}">checked="checked"</c:if>/><span>女</span></label>
                                </li>
                                <li><label class="user_title_name">手&nbsp;机&nbsp;号：</label><input name="phone" type="text"  class="add_text" value="${user.phone}"/><i id="phoneMess">*</i></li>
                                <li><label class="user_title_name">邮箱地址：</label><input name="email" type="text"  class="add_text" value="${user.email}"/><i id="emailMess">*</i></li>
                            </ul>
                            <div class="operating_btn"><input id="submit" type="button" value="提交"  class="submit—btn"/></div>
                        </div>
                    </form>
                </div>
            </div>
