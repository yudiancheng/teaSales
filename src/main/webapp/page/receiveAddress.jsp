                ...
                <div class="about_user_info">
                    <form id="form1">
                        <div class="user_layout">
                            ...
                            <div class="operating_btn"><input name="submit" type="button" value="确认" class="submit—btn">
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="list">
                        <c:if test="${not empty userAddress}">
                            ...
                            <c:forEach items="${userAddress}" var="address">
                                <tr>
                                    <input type="hidden" name="hidden" value="${address.id}"/>
                                <td>${address.receiverName}</td>
                                <td>${address.location}</td>
                                <td>${address.postalCode}</td>
                                <td>${address.phone}</td>
                                <td>${address.detailedAddress}</td>
                                <td><a href="javascript:window.open('/teaSales/page/updAddress.jsp?id=${address.id}&name=${address.receiverName}&postalCode=${address.postalCode}&phone=${address.phone}&detailed=${address.detailedAddress}','_blank', 'resizable=no,top=300px,location=no');">修改</a><a href="javascript:delAddress()">删除</a></td>
                            </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                        ...
                        <c:if test="${empty userAddress}">
                            <div style="color: darkorange;text-align: center;font-size: large">您当前没有添加任何地址！</div>
                        </c:if>
                    </div>
                </div>
            </div>
