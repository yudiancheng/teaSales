    ...
    <div class="clearfix user" >
        ...
        <div class="right_style r_user_style user_right">
            <div class="user_Borders">
                ...
                <div style="text-align: left;margin-top: 20px;height: 100%;overflow: auto">
                <c:forEach items="${userComment}" var="content">
                    <input type="hidden" name="id" value="${content.id}">
                    <div>
                        <img src="products/${content.product.image}">
                    </div>
                    <c:out value="${content.content}"></c:out>&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="javascript:void(0);">赞(${content.support})</a>&nbsp;&nbsp;&nbsp;&nbsp;<a style="cursor: pointer" href="javascript:submitDel();">删除</a></span>
                    <hr style="color: slategrey"/>
                </c:forEach>
                </div>
                </c:if>
                <c:if test="${empty userComment}">
                    <div style="color: darkorange;text-align: center;font-size: large">暂时无评论！</div>
                </c:if>
            </div>
        </div>
    </div>
