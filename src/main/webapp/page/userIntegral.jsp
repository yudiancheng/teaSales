        ...
        <div class="right_style r_user_style">
            <div class="user_Borders">
                ...
                <div class="user_integral_style slideTxtBox">
                    ...
                    <div class="bd">
                        <ul>
                            <div class="Integral_Number"><em></em>你当前的积分：<b>${getCount}</b></div>
                            <c:if test="${not empty integralGetRecords}">
                            <table>
                                <thead>
                                ...
                                <tbody>
                                <c:forEach items="${integralGetRecords}" var="integralGetRecord">
                                <tr>
                                    <td><c:if test="${empty integralGetRecord.order}">通过评论获取</c:if>${integralGetRecord.order.id}</td>
                                    <td><c:choose><c:when test="${empty integralGetRecord.order}">通过评论获取</c:when><c:otherwise>￥${integralGetRecord.order.actualPay}</c:otherwise></c:choose></td>
                                    <td>${integralGetRecord.integral}</td>
                                    <td>${integralGetRecord.time}</td>
                                </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                            </c:if>
                            <c:if test="${empty integralGetRecords}">
                                <div style="color: darkorange;text-align: center;font-size: large">当前无积分获取记录！</div>
                            </c:if>
                        </ul>
                        <ul>
                            <div class="Integral_Number"><em></em>你消费的积分：<b>${useCount}</b></div>
                            <c:if test="${not empty integralUseRecords}">
                                <table>
                                    <thead>
                                    <c:forEach items="${integralUseRecords}" var="integralUseRecord">
                                    <tr>
                                        <td>积分获取订单号</td>
                                        <td>订单金额</td>
                                        <td>积分</td>
                                    ...
                                    <tbody>
                                    <tr>
                                        <td>${integralUseRecord.order.id}</td>
                                        <td>￥${integralUseRecord.order.actualPay}</td>
                                        <td>${integralUseRecord.order.actualPay}</td>
                                        <td>${integralUseRecord.time}</td>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
                            ...
                            <c:if test="${empty integralUseRecords}">
                                <div style="color: darkorange;text-align: center;font-size: large">当前无积分使用记录！</div>
                            </c:if>
                        </ul>
                    </div>
                </div>
