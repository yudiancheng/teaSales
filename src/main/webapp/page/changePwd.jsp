                ...
                <div class="about_user_info">
                    <form id="form1">
                        <div class="user_layout">
                            <ul >
                                <li><label class="user_title_name">原密码：</label><input name="password" type="password"  class="add_text"/><i id="passMessage">*</i></li>
                                <li><label class="user_title_name">新密码：</label><input name="newpass" type="password"  class="add_text"/><i id="newPassMess">*</i></li>
                                <li><label class="user_title_name">确认新密码：</label><input name="repass" type="password"  class="add_text"/><i id="rePassMess">*</i></li>
                            </ul>
                            <div class="operating_btn"><input name="submit" type="button" value="确认"  class="submit—btn"/></div>
                        </div>
                    </form>
...
<script type="text/javascript">
    ...
    function  checkNewPass() {
        ...
        var patt = /^[a-zA-Z0-9]{6,20}$/;
        if(!patt.test($newpass)) {
            $("#newPassMess").text("密码不能包含特殊字符！长度在6-20之间！");
            return false;
        }
        $("#newPassMess").text("*");
        return true;
    ...
    function beforeSubmit() {
        if(checkPass() && checkNewPass() && checkEqPass()) {
            submitData();
        }
    }
    ...
    function submitData() {
        $.ajax({
            ...
            success:function(data){
                if(data == "成功") {
                    alert("密码修改成功,请重新登录！");
                    window.location.href = "/teaSales/loginPage.jsp";
                } else {
                    alert("原密码错误！");
                }
            }
