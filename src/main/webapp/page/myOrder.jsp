                    ...
                    <div class="list">
                        <ul>
                            <c:if test="${not empty user.orders}">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${orders.status eq 0}">待付款</c:when>
                                                <c:when test="${orders.status eq 1}">已成功</c:when>
                                                <c:when test="${orders.status eq 2}">待收货</c:when>
                                                <c:when test="${orders.status eq 3}">待发货</c:when>
                                                <c:when test="${orders.status eq 4}">正在退款</c:when>
                                            </c:choose>
                                        </td>
                            ...
                            <c:if test="${empty user.orders}">
                                <div style="color: darkorange;text-align: center;font-size: large">暂时无订单！</div>
                            </c:if>
                        </ul>
                    </div>
                </div>
